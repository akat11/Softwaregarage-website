...
export default function About() {
  ...
  return <div ref={containerRef} className="about-reference">
    ...
    <section className="about-ref-wrap"><div className="container about-ref-container">
      ...
      <div className="about-ref-grid"><div className="about-who"><h2>WHO <span>WE ARE</span></h2><p>We are a team of creative thinkers, designers, developers, and problem solvers who turn ideas into powerful digital products.</p><p>From startups to established enterprises, we partner with businesses of all sizes to turn their vision into scalable, future-ready solutions.</p><b><span className="about-target-icon"><Target size={42} /><ArrowUpRight size={20} /></span><span className="about-target-text">WE DON'T JUST BUILD WEBSITES OR APPS.<br /><span>WE BUILD </span><em>SOLUTIONS </em><span>THAT</span><em> SOLVE REAL BUSINESS PROBLEMS.</em></span></b></div><div className="about-values"><h2>OUR <span>VALUES</span></h2>{values.map(({ icon: Icon, title, text }) => <article key={title}><Icon size={46} strokeWidth={1.55} /><div><b>{title}</b><p>{text}</p></div></article>)}</div></div>
      ...
      <div className="about-final-cta-content">
        ...
        <div className="about-final-cta-copy">
          ...
          <div className="about-final-cta-actions">
            <a className="about-cta-primary" href="/contact" data-cursor="expand">START A PROJECT <ArrowUpRight size={18} /></a>
            <a className="about-cta-secondary" href="/contact" data-cursor="expand">TALK TO THE GARAGE <ArrowUpRight size={18} /></a>
          </div>
        </div>
