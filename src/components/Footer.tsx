  ...
  return (
    <footer className="site-footer">
          ...
          <div className="footer-menu-block">
            ...
            <nav className="footer-links" aria-label="Social navigation">
              {socialLinks.map((item) => (
                <a key={item.label} href={item.href} target="_blank" rel="noreferrer noopener" data-cursor="expand">
                  {item.label}
                </a>
              ))}
            </nav>
      ...
      <div className="footer-bottom">
        ...
        <Link to="/contact" className="footer-cta" aria-label="Contact us" data-cursor="expand" />
      </div>
    </footer>
  )
}
